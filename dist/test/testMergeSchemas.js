    ...
    return __generator(this, function (_a) {
        describe('merging ' + combination.name, function () {
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            mergedSchema = mergeSchemas_1.default({
                                schemas: [propertySchema, bookingSchema, scalarTest, linkSchema, testingSchemas_1.subscriptionSchema],
            ...
            describe('basic', function () {
                ...
                it('subscriptions', function () { return __awaiter(_this, void 0, void 0, function () {
                    var subscriptionFragment, notificationResult, mergedResult;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                subscriptionFragment = "\n          subscription Subscription {\n            notifications {\n              text\n            }\n          }\n        ";
                                return [4 /*yield*/, graphql_1.graphql(testingSchemas_1.subscriptionSchema, subscriptionFragment, {}, {})];
                            case 1:
                                notificationResult = _a.sent();
                                return [4 /*yield*/, graphql_1.graphql(mergedSchema, subscriptionFragment, {}, {})];
                            case 2:
                                mergedResult = _a.sent();
                                chai_1.expect(notificationResult).to.have.nested.property('data.notifications');
                                chai_1.expect(mergedResult).to.deep.equal(notificationResult);
                                return [2 /*return*/];
                        }
                    });
                }); });
